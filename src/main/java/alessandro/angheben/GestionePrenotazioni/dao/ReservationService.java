...
public class ReservationService {
    ...
    public void save(Reservation reservation) {
        ...
        long freeDesks = reservationDAO.findFreeDesksByReservationDate(reservation.getDesk(),reservation.getReservationDate());
       ...
       // reservation.getDesk().getMaxGuests()

        if (freeDesks < reservation.getDesk().getMaxGuests()) {
